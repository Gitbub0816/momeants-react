...
export const DEMO_CONVERSATIONS: Conversation[] = [
  {
    ...
    participants: [{ userId: 'u5', displayName: 'Ava Chen', avatarUri: 'https://i.pravatar.cc/150?u=ava' }],
    lastMessage: { text: 'Shared a memory', senderName: 'Ava Chen', sentAt: '2024-11-14T09:18:00Z', isFromMe: false },
  ...
  },
  {
    ...
    participants: [
      { userId: 'u2', displayName: 'Mom', avatarUri: 'https://i.pravatar.cc/150?u=mom' },
      { userId: 'u3', displayName: 'Dad', avatarUri: 'https://i.pravatar.cc/150?u=dad' },
      { userId: 'u4', displayName: 'Sam', avatarUri: 'https://i.pravatar.cc/150?u=sam' },
    ],
    lastMessage: { text: '😂', senderName: 'Mom', sentAt: '2024-11-13T18:41:00Z', isFromMe: false },
  ...
  },
  {
    ...
    participants: [
      { userId: 'u5', displayName: 'Ava', avatarUri: 'https://i.pravatar.cc/150?u=ava' },
      { userId: 'u6', displayName: 'Noah', avatarUri: 'https://i.pravatar.cc/150?u=noah' },
      { userId: 'u7', displayName: 'Mia', avatarUri: 'https://i.pravatar.cc/150?u=mia' },
    ],
    lastMessage: { text: 'Ava started a Spark', senderName: 'Ava', sentAt: '2024-11-14T10:05:00Z', isFromMe: false },
